...
class user_control extends base_common_control {
    ...
    public function on_logout() {
        if (misc::form_submit()) {
            core::C('auth', '', -1);
            //$this->show('vc/user/logout', $this->conf['app_dir']);
            $this->show('vc/user/logout', $this->conf['app_dir']);
        } else {
